<template>
  <v-app>
    <v-navigation-drawer fixed app class="pa-4">
      <upload @file="upload" />
      <count :nodeCount="nodeCount" :edgeCount="edgeCount" />
      <showEdges v-model="showEdges" />
      <edgeOpacity v-model="edgeOpacity" />
      <size v-model="size" />
      <sizeField v-model="sizeField" :fields="fields" />
      <toggleLayout @click="toggleLayout" :layoutRunning="layoutRunning" />
      <energy v-model="alpha" :disabled="this.layoutRunning" />
      <chargeStrength v-model="chargeStrength" />
      <chargeApprox v-model="theta" />
      <collideStrength v-model="collideStrength" />
      <linkStrength v-model="linkStrength" />
      <centerStrength v-model="center" />
      <xStrength v-model="xStrength" />
      <xField v-model="xField" :fields="fields" />
      <yStrength v-model="yStrength" />
      <yField v-model="yField" :fields="fields" />
      <radialStrength v-model="radialStrength" />
      <radialField v-model="radialField" :fields="fields" />
...
import ShowEdges from "./components/ShowEdges";
import EdgeOpacity from "./components/EdgeOpacity";
import Size from "./components/Size";
import SizeField from "./components/SizeField";
import ToggleLayout from "./components/ToggleLayout";
import Energy from "./components/Energy";
import ChargeStrength from "./components/ChargeStrength";
import ChargeApprox from "./components/ChargeApprox";
import CollideStrength from "./components/CollideStrength";
import LinkStrength from "./components/LinkStrength";
import CenterStrength from "./components/CenterStrength";
import XStrength from "./components/XStrength";
import XField from "./components/XField";
import YStrength from "./components/YStrength";
import YField from "./components/YField";
import RadialStrength from "./components/RadialStrength";
import RadialField from "./components/RadialField";
